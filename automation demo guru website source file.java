...
public class project {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.setProperty("webdriver.gecko.driver","c:\\Users\\acer\\Desktop\\seleninum jar\\geckodriver.exe");
		...
		Thread.sleep(2000);
		w.findElement(By.linkText("REGISTER")).click();
		w.findElement(By.name("firstName")).sendKeys("chilla");
		w.findElement(By.name("lastName")).sendKeys("prathyusha");
		w.findElement(By.name("phone")).sendKeys("1234546578");
		w.findElement(By.name("userName")).sendKeys("prathyusha@gmail.com");
		w.findElement(By.name("address1")).sendKeys("reddipalla");
		...
		w.findElement(By.name("email")).sendKeys("prathyusha@gmail.com");
	...
	//	w.findElement(By.xpath("//*[@id=\"download_now\"]")).click();
		...
		w.findElement(By.name("uploadfile_0")).sendKeys("c:\\Users\\acer\\Desktop\\Doc1.docx");
		Thread.sleep(2000);
		...
		w.findElement(By.xpath("//*[@id=\"photoimg\"]")).sendKeys("c:\\Users\\acer\\Desktop\\Doc1.docx");
		Thread.sleep(5000);
		w.navigate().back();
